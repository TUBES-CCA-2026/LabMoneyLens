...
<aside id="main-sidebar" class="sidebar" data-turbo-permanent>
  ...
  <nav class="sidebar-nav">
    ...
    @unless(session('user_role') == 'Kepala Lab')
      <a href="{{ route('pengeluaran.pilih') }}" class="nav-item {{ request()->routeIs('pengeluaran.*') ? 'active' : '' }}">
        <svg viewBox="0 0 24 24" stroke-width="1.8"><circle cx="12" cy="12" r="9"/><path d="M12 8v4l3 3"/></svg>
        Pengeluaran
      </a>
      <a href="{{ route('pemasukan.pilih') }}" class="nav-item {{ request()->routeIs('pemasukan.*') ? 'active' : '' }}">
        <svg viewBox="0 0 24 24" stroke-width="1.8"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
        Pemasukan
      </a>
    @endunless
    <a href="{{ route('struk') }}" class="nav-item {{ request()->routeIs('struk') ? 'active' : '' }}">
    ...
    @unless(session('user_role') == 'Kepala Lab')
      <a href="{{ route('recycle') }}" class="nav-item {{ request()->routeIs('recycle') ? 'active' : '' }}">
