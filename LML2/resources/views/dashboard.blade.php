  ...
  (function () {
    ...
    function renderChart(categories) {
      ...
      categories.forEach(cat => {
        ...
        const tooltip = `${cat.category}: ${formatRp(cat.total)}`;
        barsHtml += `<div class="chart-bar" title="${tooltip.replace(/&/g, '&amp;').replace(/\"/g, '&quot;').replace(/</g, '&lt;').replace(/>/g, '&gt;')}" aria-label="${tooltip.replace(/&/g, '&amp;').replace(/\"/g, '&quot;').replace(/</g, '&lt;').replace(/>/g, '&gt;')}">
