  ...
  <div class="app">
    ...
    <main class="main">
      <div class="page-wrapper">
        ...
        <!-- Back Button -->
        <a href="<?php echo e(route('welcome')); ?>" class="back-btn">
        ...
        <div class="form-card">
          ...
          <div class="form-card-body">
            ...
            <form id="manual_form" method="POST" action="<?php echo e(route('pengeluaran.store-manual')); ?>" enctype="multipart/form-data" class="input-form">
              <?php echo csrf_field(); ?>
              ...
              <div id="preview-container" style="display:none; margin-bottom:20px; background: linear-gradient(135deg, #fef2f2 0%, #fff9f9 100%); border: 2px solid #fecaca; border-radius: 14px; padding: 16px; text-align: center;">
                ...
                <div style="margin-top: 12px; display: flex; gap: 10px;">
                  <button type="button" class="reset-btn" onclick="clearPreview()" style="flex: 1; border-color: #dc2626; color: #dc2626;">🗑 Hapus Foto</button>
                </div>
              </div>
...
<?php /**PATH C:\Users\LOQ\OneDrive\Documents\codingan\TUBES\LabMoneyLens\resources\views/pengeluaran_manual.blade.php ENDPATH**/ ?>