  ...
  <div class="app">
    ...
    <main class="main">
      <div class="page-wrapper">
        ...
        <!-- Back Button -->
        <a href="<?php echo e(route('pengeluaran.pilih')); ?>" style="display:inline-flex; align-items:center; gap:6px; color:#dc2626; text-decoration:none; font-weight:600; font-size:13px; margin-bottom:10px;">
        ...
        <div class="form-card">
          ...
          <div class="form-card-body">
            ...
            <form id="receipt_form" method="POST" action="<?php echo e(route('pengeluaran.store-otomatis')); ?>" enctype="multipart/form-data" class="input-form">
              <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\LOQ\OneDrive\Documents\codingan\TUBES\LabMoneyLens\resources\views/pengeluaran_otomatis.blade.php ENDPATH**/ ?>