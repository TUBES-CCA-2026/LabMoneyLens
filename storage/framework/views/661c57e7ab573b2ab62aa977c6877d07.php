...
<head>
  ...
  <?php echo app('Illuminate\Foundation\Vite')(['resources/css/style.css','resources/css/recyclebin.css']); ?>
</head>
<body>
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('recycle')); ?>" class="nav-item active">
          <svg viewBox="0 0 24 24" stroke-width="1.8"><path d="M3 6h18"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg>
          Recycle Bin
        </a>
      </nav>
        ...
        <div class="recycle-header">
          ...
          <div class="status-cards">
            ...
            <article class="status-card time-card">
              <span class="status-label">AVERAGE TIME</span>
              <strong class="status-value"><?php echo e($averageDays); ?> Days</strong>
            </article>
...
<?php /**PATH C:\yaya\LabMoneyLens\resources\views/recycle.blade.php ENDPATH**/ ?>