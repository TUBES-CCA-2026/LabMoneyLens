...
<head>
  ...
  <title>Pilih Cara Input Pemasukan — LabMoneyLens</title>
      ...
      <div class="page-wrapper">
        ...
        <div class="page-hero">
          <div class="page-hero-info">
            ...
            <p>Pilih cara input pemasukan yang paling sesuai untuk Anda</p>
          </div>
        </div>
        ...
        <div class="choice-grid">
          <!-- Manual Option -->
          <a href="<?php echo e(route('pemasukan.manual')); ?>" class="choice-card">
            <div class="choice-icon">✏️</div>
            <div class="choice-header">
              <div class="choice-title">Input Manual</div>
              <div class="choice-subtitle">Catat tanpa perlu foto bukti</div>
            </div>
          ...
          <!-- Otomatis Option -->
          <a href="<?php echo e(route('pemasukan.otomatis')); ?>" class="choice-card">
...
<?php /**PATH C:\Users\LOQ\OneDrive\Documents\codingan\TUBES\LabMoneyLens\resources\views/pemasukan_pilih.blade.php ENDPATH**/ ?>