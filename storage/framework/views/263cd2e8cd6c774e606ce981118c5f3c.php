  ...
  <div class="app">
    ...
    <main class="main">
      <section class="panel" style="max-width: 760px; margin: 40px auto;">
        ...
        <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data" class="form-grid" style="gap: 18px;">
          <?php echo csrf_field(); ?>
...
<?php /**PATH E:\lml\LabMoneyLens\resources\views/profile.blade.php ENDPATH**/ ?>