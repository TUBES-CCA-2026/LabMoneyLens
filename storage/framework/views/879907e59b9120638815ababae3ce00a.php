...
<head>
  ...
  <title>Pemasukan — Dashboard</title>
            ...
            <tbody id="table-body">
              <?php $__empty_1 = true; $__currentLoopData = $incomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                  ...
                  <td><?php echo e(\Illuminate\Support\Carbon::parse($income->created_at)->format('d/m/Y H:i')); ?></td>
                  <td class="action-cell">
                    <a href="<?php echo e(route('pemasukan.edit', ['id' => $income->id])); ?>" class="btn-edit">Edit</a>
                    <span class="sep">/</span>
...
</html><?php /**PATH D:\revisi\LabMoneyLens\resources\views/pemasukan.blade.php ENDPATH**/ ?>