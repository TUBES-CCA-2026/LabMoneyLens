        ...
        <div class="form-card" style="max-width: 600px; margin: 0 auto; margin-top: 4vh;">
          ...
          <div class="form-card-body">
            ...
            <div id="preview-container" style="margin-bottom:24px; background: linear-gradient(135deg, #fef2f2 0%, #fee2e2 100%); border: 2px solid #fca5a5; border-radius: 14px; padding: 16px; text-align: center;">
              ...
              <img src="<?php echo e(asset('storage/' . $expense->foto_struk)); ?>" alt="Preview Struk" style="max-width: 100%; max-height: 250px; border-radius: 10px; box-shadow: 0 4px 12px rgba(239, 68, 68, 0.15);">
            </div>
            <?php endif; ?>
...
<?php /**PATH D:\Documents\Iclabs\LabML\LabMoneyLens\resources\views/pengeluaran_edit.blade.php ENDPATH**/ ?>