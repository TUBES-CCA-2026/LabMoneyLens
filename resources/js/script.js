...
(function () {
    ...
    const CONFIRM_COPY = {
        soft: {
            ...
            message:
                "Apakah Anda yakin ingin menghapus data ini?<br><br>Data akan dipindahkan ke Back Up dan masih dapat dipulihkan kembali.",
        },
        permanent: {
            title: "Konfirmasi Hapus Permanen",
            message:
                "Apakah Anda yakin ingin menghapus permanen data ini?<br><br>Data yang telah dihapus permanen tidak dapat dipulihkan kembali.",
        },
    };
    ...
    document.addEventListener(
        ...
        function (e) {
            ...
            e.preventDefault();
            const type =
                form.dataset.confirm === "permanent" ? "permanent" : "soft";
            openModal(type, form);
        },
        true,
    );
