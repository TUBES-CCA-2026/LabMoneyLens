...
<head>
  ...
  <title>Input Pemasukan Otomatis — LabMoneyLens</title>
...
<body>
  <div class="app">
    ...
    <main class="main">
      <div class="page-wrapper">
        ...
        <!-- Back Button -->
        <a href="{{ route('pemasukan.pilih') }}" style="display:inline-flex; align-items:center; gap:6px; color:#0d9488; text-decoration:none; font-weight:600; font-size:13px; margin-bottom:10px;">
        ...
        <div class="form-card">
          ...
          <div class="form-card-body">
            ...
            <form id="receipt_form" method="POST" action="{{ route('pemasukan.store-otomatis') }}" enctype="multipart/form-data" class="input-form">
              @csrf
  ...
  <script>
    ...
    async function analyzeReceipt(file) {
      ...
      const receiptType = document.getElementById("receipt_type")?.value || "pemasukan";
    ...
    function fillParsedReceipt(data) {
      ...
      if (data.kategori) {
        const select = document.getElementById("kategori_penerimaan") || document.getElementById("id_jenis_penerimaan");
        if (select) {
