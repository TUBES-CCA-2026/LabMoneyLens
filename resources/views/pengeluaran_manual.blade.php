...
<head>
  ...
  <title>Input Pengeluaran Manual — LabMoneyLens</title>
      ...
      <div class="page-wrapper">
        ...
        <div class="page-hero">
          <div class="page-hero-info">
            <h1>Input Pengeluaran Manual</h1>
            <p>Catat pengeluaran baru secara manual tanpa perlu foto struk.</p>
          </div>
        ...
        <div class="form-card">
          <div class="form-card-header">
            ...
            <div>
              <h2>Form Pengeluaran Manual Baru</h2>
          ...
          <div class="form-card-body">
            ...
            <form id="manual_form" method="POST" action="{{ route('pengeluaran.store-manual') }}" enctype="multipart/form-data" class="input-form">
              @csrf
              ...
              <div class="upload-row" id="upload-row" role="button" tabindex="0" aria-label="Unggah foto struk" style="background: #f8fafc; border: 2px dashed #cbd5e1; border-radius: 12px; padding: 16px; display: flex; align-items: center; justify-content: space-between; cursor: pointer; margin-bottom: 20px; transition: all 0.2s;">
                ...
                <button type="button" class="upload-row-btn" onclick="document.getElementById('receipt_image').click()" style="background: #dc2626; color: #fff; border: none; padding: 8px 16px; border-radius: 8px; font-weight: 600; font-size: 12px; cursor: pointer;">Pilih File</button>
              </div>

              <!-- Preview Foto Struk -->
              <div id="preview-container" style="display:none; margin-bottom:20px; background: linear-gradient(135deg, #fef2f2 0%, #fff9f9 100%); border: 2px solid #fecaca; border-radius: 14px; padding: 16px; text-align: center;">
              ...
              <div id="form-blocker" style="position:relative;">
                <div id="form-overlay" style="position:absolute;inset:0;background:rgba(255,255,255,0.85);z-index:10;border-radius:12px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;backdrop-filter:blur(2px);">
                  ...
                  <div style="font-size:14px;font-weight:700;color:#991b1b;text-align:center;">Upload Foto Struk / Kwitansi Terlebih Dahulu</div>
              ...
              <div class="form-grid">
                ...
                <div class="form-group">
                  ...
                  <select class="form-input" id="kategori_pengeluaran" name="kategori_pengeluaran" required>
              ...
              <div id="items-container">
                <div class="form-grid item-row" style="position: relative; padding-bottom: 20px; margin-bottom: 20px; border-bottom: 1px dashed #fecaca;">
                  ...
                  <input type="hidden" name="id_jenis_pengeluaran[]" class="row-kategori-sync" value="">
                  <!-- Keterangan -->
              ...
              <div style="display: flex; gap: 10px; margin-bottom: 10px;">
                <button type="button" class="reset-btn" onclick="tambahBarisManual()" style="flex: 1; border-style: dashed; color: #dc2626; border-color: #fca5a5;">
                ...
                <button type="button" class="reset-btn" onclick="tambahKategoriManual()" style="flex: 1; border-style: dashed; color: #b45309; border-color: #fcd34d;">
        ...
        <div class="table-section">
          ...
          <div style="margin-top: 20px; padding: 0 20px;">
            <style>
              ...
              .page-item .page-link { display: block; padding: 6px 12px; border: 1px solid #cbd5e1; border-radius: 6px; color: #ef4444; text-decoration: none; font-size: 13px; background: #fff; transition: all 0.2s ease; }
              .page-item .page-link:hover { background: #fef2f2; }
              .page-item.active .page-link { background: #dc2626; color: #fff; border-color: #dc2626; }
...
>>>>>>> 0026227 (Baru)
    ...
    function tambahBarisManual() {
      ...
      newRow.style.cssText = 'position: relative; padding-bottom: 20px; margin-bottom: 20px; border-bottom: 1px dashed #fecaca;';
    ...
    function tambahKategoriManual() {
      ...
      newRow.innerHTML = `
        <div class="form-group">
          ...
          <select class="form-input" id="kategori_${rowCount}" name="id_jenis_pengeluaran[]" required>
            ${kategoriOptions}
          </select>
        </div>
        <div class="form-group">
